        ...
        try:
            ...
            if inspection:
                data = {
                    ...
                    'unsafe_driver_inspection_violation': value.get('UNSAFE_DRIV_INSP_W_VIOL'),
                    'unsafe_driver_measure': value.get('UNSAFE_DRIV_MEASURE'),
                    'hos_driver_inspection_violation': value.get('HOS_DRIV_INSP_W_VIOL'),
                    'hos_driver_measure': value.get('HOS_DRIV_MEASURE'),
                    'driver_fit_inspection_violation': value.get('DRIV_FIT_INSP_W_VIOL'),
                    'driver_fit_measure': value.get('DRIV_FIT_MEASURE'),
                    'contr_subst_inspection_violation': value.get('CONTR_SUBST_INSP_W_VIOL'),
                    'contr_subst_measure': value.get('CONTR_SUBST_MEASURE'),
                    'vehicle_maintenance_violation': value.get('VEH_MAINT_INSP_W_VIOL'),
                    'vehicle_maintenance_measure': value.get('VEH_MAINT_MEASURE'),
                }
